    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          ...
          content:
            "If you believe content on LoLympic infringes your copyright, submit a DMCA takedown notice to dkdnel95@gmail.com including:",
          list: [
    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          title: "3. DMCA 삭제 절차",
          content:
            "LoLympic의 콘텐츠가 귀하의 저작권을 침해한다고 판단되는 경우, 다음을 포함하여 dkdnel95@gmail.com으로 DMCA 삭제 통지를 제출해 주십시오:",
          list: [
            "저작권이 있는 저작물의 식별",
    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          title: "3. DMCA削除手続き",
          content:
            "LoLympic上のコンテンツがお客様の著作権を侵害していると思われる場合は、以下を含むDMCA削除通知をdkdnel95@gmail.comに提出してください：",
          list: [
            "著作権のある著作物の特定",
    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          title: "3. DMCA删除流程",
          content:
            "如果您认为LoLympic上的内容侵犯了您的版权，请向dkdnel95@gmail.com提交DMCA删除通知，包括：",
          list: [
            "受版权保护作品的标识",
            "LoLympic上侵权内容的URL",
            "您的联系信息",
    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          ...
          content:
            "Si cree que el contenido en LoLympic infringe sus derechos de autor, envíe un aviso de eliminación DMCA a dkdnel95@gmail.com incluyendo:",
          list: [
    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          ...
          content:
            "यदि आपको लगता है कि LoLympic पर सामग्री आपके कॉपीराइट का उल्लंघन करती है, तो निम्नलिखित सहित dkdnel95@gmail.com पर DMCA हटाने की सूचना जमा करें:",
          list: [
    ...
    copyright: {
      ...
      blocks: [
        ...
        },
        {
          ...
          content:
            "إذا كنت تعتقد أن المحتوى على LoLympic ينتهك حقوق النشر الخاصة بك، فقدم إشعار إزالة DMCA إلى dkdnel95@gmail.com متضمنًا:",
          list: [
